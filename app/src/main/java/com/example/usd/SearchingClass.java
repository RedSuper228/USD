...
public class SearchingClass {
    ...
    public static String bible = "Genesis 1:1\tIn the beginning God created the heaven and the earth.\n" +
    ...
    public static String test = "\tTest speech no lke other meow bark.\n";


    public static String divineInText(String strQuestion){
        test.indexOf(strQuestion);
        char[] cbible = test.toCharArray();
        char[] question = strQuestion.toCharArray();

        int i = simpleTextSearch(question, cbible);

        return test.substring(findFirstIndex(i, test), findLastIndex(i, test));
    }

    public static int findFirstIndex(int i, String bible){
        int c = i-1;
        Character ch1 = new Character(bible.charAt(c));
        Character ch2 = new Character(bible.charAt(c-1));

        while (true){
            if ((ch1.equals("t")) && (ch2.equals("//"))){
                return c+1;
            }else {
                c--;
                ch1 = bible.charAt(c);
                ch2 = bible.charAt(c-1);
